...
for i,r in enumerate(range(1,sheet1.getNumRows(),1)):
    ...
    row.addCell(tcCro, sheet1.getCellValue(r,3))
    row.addCell(tcAssayDate, sheet1.getCellValue(r,4))
    row.addCell(tcOrganism, sheet1.getCellValue(r,5))
    row.addCell(tcStrain, sheet1.getCellValue(r,6))
    row.addCell(tcSex, sheet1.getCellValue(r,7))
    row.addCell(tcCondition, sheet1.getCellValue(r,8))
    row.addCell(tcStudyType, sheet1.getCellValue(r,9))
    row.addCell(tcTMaxH, sheet1.getCellValue(r,10))
    row.addCell(tcTHalfH, sheet1.getCellValue(r,11))
    row.addCell(tcTHalfSdH, sheet1.getCellValue(r,12))
    row.addCell(tcVDistributLKg, sheet1.getCellValue(r,13))
    row.addCell(tcVDistributSdLKg, sheet1.getCellValue(r,14))
    row.addCell(tcClearanceMlMinKg, sheet1.getCellValue(r,15))
    row.addCell(tcClearanceSdMlMinKg, sheet1.getCellValue(r,16))
    row.addCell(tcAucMeasured, sheet1.getCellValue(r,17))
    row.addCell(tcAucMeasuredSd, sheet1.getCellValue(r,18))
    row.addCell(tcAucMeasUnits, sheet1.getCellValue(r,19))
    row.addCell(tcMrtH, sheet1.getCellValue(r,20))
    row.addCell(tcMrtSdH, sheet1.getCellValue(r,21))
    row.addCell(tcAucBrainPlasma, sheet1.getCellValue(r,22))
    row.addCell(tcBioavailabilityPct, sheet1.getCellValue(r,23))
    row.addCell(tcFormulation, sheet1.getCellValue(r,24))
    row.addCell(tcNominalDoseMgKg, sheet1.getCellValue(r,25))
    row.addCell(tcAdminRoute, sheet1.getCellValue(r,26))
    row.addCell(tcMatrix, sheet1.getCellValue(r,27))
    row.addCell(tcTimeH, sheet1.getCellValue(r,28))
    row.addCell(tcConcMeanNm, sheet1.getCellValue(r,29))
    row.addCell(tcConcSdNm, sheet1.getCellValue(r,30))
    row.addCell(tcBrainPlasmaMean, sheet1.getCellValue(r,31))
    row.addCell(tcBrainPlasmaSd, sheet1.getCellValue(r,32))
