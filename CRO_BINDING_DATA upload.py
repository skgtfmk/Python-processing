...
for i,r in enumerate(range(1,sheet1.getNumRows(),1)):
    ...
    row.addCell(tcUnboundQual, sheet1.getCellValue(r,10))
    row.addCell(tcPercUnbound, sheet1.getCellValue(r,11))
    row.addCell(tcPercUnboundSd, sheet1.getCellValue(r,12))
    row.addCell(tcBoundQual, sheet1.getCellValue(r,13))
    row.addCell(tcPercBound, sheet1.getCellValue(r,14))
    row.addCell(tcPercBoundSd, sheet1.getCellValue(r,15))
    row.addCell(tcRecoveryQual, sheet1.getCellValue(r,16))
    row.addCell(tcPercRecov, sheet1.getCellValue(r,17))
    row.addCell(tcPercRecovSd, sheet1.getCellValue(r,18))
    row.addCell(tcComments, sheet1.getCellValue(r,19))
